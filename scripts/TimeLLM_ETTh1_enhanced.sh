...
RESUME_FROM=""
# 断点续训示例:
# RESUME_FROM="${CHECKPOINTS}/long_term_forecast_ETTh1_512_96_TimeLLM_ETTh1_ftM_sl512_ll48_pl96_dm64_nh8_el2_dl1_df128_fc3_ebtimeF_test_0-GPT2_Enhanced/checkpoint_step_1000/checkpoint.pt"
...
# - LAMBDA_TREND: 测试 0.05, 0.1, 0.2 对比辅助损失权重
# - LAMBDA_RETRIEVAL: 测试 0.05, 0.1, 0.2 对比辅助损失权重
#
# ============================================================
